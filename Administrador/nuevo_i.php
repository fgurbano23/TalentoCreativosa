	...
	<div class="container">
        <div class="row">
            <div class="col-md-12 c1">
                <h2>
                    <a href=<?php echo ruta.'/Administrador/PanelDeControl.php';?>>Panel de Control</a> / <a href=<?php echo ruta.'/Administrador/imagenes_admin.php';?>>Imagenes</a> / Nueva Imagen
                </h2>
            </div>
            <div class="col-md-6 col-xs-6 c5">  
                <a href=<?php echo ruta.'/Administrador/imagenes_admin.php';?> class="btn btn-lg btn-default">Volver</a>
            </div>
